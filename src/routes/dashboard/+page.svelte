...
<main class="flex flex-col items-center gap-16">
	...
	{#if selected}
		<section>
			<div class="flex flex-col gap-5 items-center w-full max-w-7xl mx-auto">
				<div class="my-6" style="width: 1000px; height: 600px">
					<img src={selected.photo} alt="" class="rounded-3xl w-full h-full object-cover" />
				</div>
			</div>
		</section>
							...
							<div class="flex gap-6">
								<div>
									<div class="mb-6" style="width: 450px; height: 300px">
										<img src={event.photo} alt="" class="rounded-3xl w-full h-full object-cover" />
									</div>
									<div class="ml-5">
										<Heading
											tag="h3"
	...
	{:else}
		<div class="flex gap-5">
			...
			<img
				src={example_dashboard_img}
				alt=""
				class="rounded-md bg-gray-100 dark:bg-gray-600 text-gray-600 dark:text-gray-300 max-w-4xl"
			/>
		</div>
	{/if}
</main>
